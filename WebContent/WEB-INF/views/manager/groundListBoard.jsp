		...
		<div class="card">
			<div class="card-body">
				<form action="/manager/groundlistboard" method="get" class="forms-sample form-ground-top">
					<input type="text" class="form-control form-input input-ground-search text-secondary" name="searchValue" placeholder="내용을 입력해주세요">
				...
				<table class="table text-secondary">	
					<thead>
						<tr>
							<th class="text-secondary">구장</th>
							<th class="text-secondary">이름</th>
							<th class="text-secondary">위치</th>
							<th class="text-secondary">이용금액</th>
							<th class="text-secondary">종목</th>
							<th class="text-secondary">지역</th>
							<th class="text-secondary">수정</th>
							<th class="text-secondary">삭제</th>
						</tr>
					</thead>
