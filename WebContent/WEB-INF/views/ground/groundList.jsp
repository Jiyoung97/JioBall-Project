			...
			<div class="card-body">
				...
				<div class="col-xl-auto col-sm-8 grid-margin stretch-card">
					<div class="ground-list">
						<a href="/ground/view?groundNo=<%=groundInfo.get(i).getGroundNo() %>"><img class="ground-list-img" alt="" src="<%=groundInfo.get(i).getGroundImgPath() %>/<%=groundInfo.get(i).getGroundImgName() %>.jpg"></a>
